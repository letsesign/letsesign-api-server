...
const jsonConfig = JSON.parse(readFileSync(join(configDir, 'submit-bulk-task.json')).toString('utf-8'));
...
const proc = async () => {
  const result = await axios.post('http://localhost/submit-bulk-task', {
